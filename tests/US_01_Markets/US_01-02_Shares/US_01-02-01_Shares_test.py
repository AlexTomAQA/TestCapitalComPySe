...
class TestSharesItemPage:
    ...
    @allure.step("Start test of [Add to favourite] button on menu item 'Shares'")
    @pytest.mark.test_001
    def test_001_shares_menu_item_add_to_favourite_button(
        ...
        bid = build_dynamic_arg_v4(
            ...
            ".01_001", "Testing button [Add to favourite] on menu item 'Shares'")
