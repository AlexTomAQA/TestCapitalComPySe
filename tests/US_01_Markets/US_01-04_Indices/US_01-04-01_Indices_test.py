...
class TestIndicesItemPage:
    ...
    @allure.step("Start test of button [Add to favourite] on trading instrument page")
    ...
    def test_010_page_trading_instrument_widget_trading_calculator_start_trading_button(
            self, worker_id, d, cur_language, cur_country, cur_role, cur_login, cur_password, cur_item_link):
        """
        ...
        bid = build_dynamic_arg_v4(
            d, worker_id, cur_language, cur_country, cur_role,
            "01.04", "Markets > Menu item [Indices]",
            ".01_010", "Testing button [Start Trading] in the 'Trading calculator' widget")
    ...
    def test_012_block_step_trading_create_verify_your_account(
            self, worker_id, d, cur_language, cur_country, cur_role, cur_login, cur_password, cur_item_link):
        """
        ...
        bid = build_dynamic_arg_v4(
            d, worker_id, cur_language, cur_country, cur_role,
            "01.04", "Markets > Menu item [Indices]",
            ".01_012", "Testing button [1. Create your account] in Step trading block")
