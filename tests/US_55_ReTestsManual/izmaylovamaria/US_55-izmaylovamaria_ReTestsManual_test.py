...
class TestManualDetectedBugs:
    ...
    @pytest.mark.parametrize('cur_role', ["Auth"])
    @pytest.mark.test_010b
    def test_010b(self, worker_id, d, cur_language, cur_country, cur_role, cur_login, cur_password, cur_market):
        """
        ...
        bid = build_dynamic_arg_for_us_55(
            d, worker_id, cur_language, cur_country, cur_role,
            "55", "Retest of manual detected bugs",
            "10b", "Testing button [Buy] on trading instrument page", False, False)
        pytest.skip("Autotest under construction")
    ...
    @pytest.mark.test_55
    def test_010c(self, worker_id, d, cur_language, cur_country, cur_role, cur_login, cur_password, cur_market):
        """
        ...
        bid = build_dynamic_arg_for_us_55(
            d, worker_id, cur_language, cur_country, cur_role,
            "55", "Retest of manual detected bugs",
            "10c", "Testing button [Notification] on trading instrument page", False, False)
        pytest.skip("Autotest under construction")
    ...
    @pytest.mark.test_55
    def test_010d(self, worker_id, d, cur_language, cur_country, cur_role, cur_login, cur_password, cur_market):
        """
        ...
        bid = build_dynamic_arg_for_us_55(
            d, worker_id, cur_language, cur_country, cur_role,
            "55", "Retest of manual detected bugs",
            "10d", "Testing button [View Detailed Chart] on trading instrument page", False, False)
        pytest.skip("Autotest under construction")
