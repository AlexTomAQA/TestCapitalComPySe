...
from pages.Elements.ButtonOpenAnAccountContent import ContentOpenAnAccount
from pages.Elements.ButtonTryDemoAccountContent import ContentTryDemoAccount
...
class TestMarketGuides:
    ...
    def test_01_open_an_account(
        ...
        test_element = ContentOpenAnAccount(d, link, bid)
    ...
    def test_02_try_demo_account(
        ...
        menu = MenuSection(d, link)
        link = menu.open_education_cfd_trading_menu(d, cur_language, cur_country, link)

        test_element = ContentTryDemoAccount(d, link, bid)
        test_element.full_test_with_tpi(d, cur_language, cur_country, cur_role, link)
