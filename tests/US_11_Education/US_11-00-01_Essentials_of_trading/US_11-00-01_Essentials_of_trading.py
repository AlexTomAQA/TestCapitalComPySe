...
class TestEssentialsTrading:
    ...
    @allure.step("Start test_11.00.01_02 button [Create a risk free demo account] in Unleveraged trading block")
    @pytest.mark.test_02
    ...
    @allure.step("Start test_11.00.01_03 button [Create a live account]")
    @pytest.mark.test_03
    ...
    @allure.step("Start test_11.00.01_04 button [Create a risk free demo account] in How to get started trading block")
    @pytest.mark.test_04
