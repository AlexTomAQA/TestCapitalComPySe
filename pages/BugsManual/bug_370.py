...
LINK_LOCATOR = (By.CSS_SELECTOR, '.main_chart__prq68')
LINK_NAME = "Discover what you can trade"
BLOCK_NAME = "Why choose Capital.com?"

class BUG_370(BasePage):

    @allure.step(f"{datetime.now()}   1. Start Arrange: find link '{LINK_NAME}' in the block '{BLOCK_NAME}'")
    def arrange(self, d, link):
        print(f"\n{datetime.now()}   1. Start Arrange: find link '{LINK_NAME}' in the block '{BLOCK_NAME}'")
