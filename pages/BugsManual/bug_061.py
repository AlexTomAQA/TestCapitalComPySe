...
class Sidebar(BasePage):
    ...
    def assert_(self, sidebar_item):
        ...
        try:
            ...
            Common.pytest_fail(f"Bug#061 Expected result: Sidebar 'Crypto trading guide' is on this pages "
                               f"Actual result: Sidebar 'Crypto trading guide' is absent on this pages")
