...
LINK_LEARN_TO_TRADE_LOC = ('xpath', '(//a[@data-type="benefits_block_block_تعلّم_التداول_btn"])[2]')
BLOCK_EXPERIENCED_LOC = ('css selector', 'div[data-id="experiencedtraders"]  a[data-type="tiles_w_img_link4_signup"]')


class Bug373(BasePage):
    @staticmethod
