...
class MenuUS01Markets:
    MENU_EN_GB_MARKETS = (By.CSS_SELECTOR, "#header a[href='/en-gb/markets'][data-type='nav_id3']")
    MENU_MARKETS_EN_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/derivative-financial-instruments'][data-type='nav_id3']")
    MENU_MARKETS_AR_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/ar/alaswaq'][data-type='nav_id3']")
    MENU_MARKETS_DE_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/de/alle-maerkte'][data-type='nav_id3']")
    MENU_MARKETS_EL_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/el/paragoga-xrimatopistotika-mesa'][data-type='nav_id3']")
    MENU_MARKETS_ES_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/es/instrumentos-financieros-derivados'][data-type='nav_id3']")
    MENU_MARKETS_FR_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/fr/instruments-financiers-derives'][data-type='nav_id3']")
    MENU_MARKETS_IT_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/it/derivati'][data-type='nav_id3']")
    MENU_MARKETS_HU_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/hu/derivativ-penzugyi-eszkozok'][data-type='nav_id3']")
    MENU_MARKETS_NL_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/nl/derivaat-financieel-instrument'][data-type='nav_id3']")
    MENU_MARKETS_PL_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/pl/pochodne-instrumenty-finansowe'][data-type='nav_id3']")
    MENU_MARKETS_RO_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/ro/instrumente-financiare-derivate'][data-type='nav_id3']")
    MENU_MARKETS_RU_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/ru/proizvodnyye-finansovyye-instrumenty'][data-type='nav_id3']")
    MENU_MARKETS_ZH_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/zh/derivative-financial-instruments'][data-type='nav_id3']")
    MENU_MARKETS_CN_BUTTON = (By.CSS_SELECTOR,
                ".cc-header a[href='https://capital.com/cn/derivative-financial-instruments'][data-type='nav_id3']")
