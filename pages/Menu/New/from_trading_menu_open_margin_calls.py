...
margin_calls_submenu_loc_fca = ("css selector", "[data-type='nav_id766']")
margin_calls_submenu_loc_sca = ("css selector", "[data-type='nav_id806']")
...
class MenuNew(MenuBase):
    ...
    def from_trading_menu_open_margin_calls(self, d, cur_language, cur_country, link):
        ...
        if cur_country == 'gb':
            ...
            submenu_locator = margin_calls_submenu_loc_fca
        if cur_country == 'ae':
            menu_locator = trading_menu_loc_sca
            submenu_locator = margin_calls_submenu_loc_sca
