...
SUBMENU_ASIC_CONTACT_US = ("css selector", "[data-type='nav_id1278']")
SUBMENU_CYSEC_CONTACT_US = ("css selector", "[data-type='nav_id1695']")
...
class MenuNew(MenuBase):
    ...
    def from_about_us_menu_open_contact_us(self, d, cur_language, cur_country, link):
        ...
        if cur_country == 'au':
            ...
            submenu_locator = SUBMENU_ASIC_CONTACT_US
        if cur_country in ['at', 'de']:
            menu_locator = AboutUsMenuNew.MENU_CYSEC_ABOUT_US
            submenu_locator = SUBMENU_CYSEC_CONTACT_US
