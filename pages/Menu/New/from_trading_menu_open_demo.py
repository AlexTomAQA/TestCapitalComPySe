...
SUB_MENU_FCA_DEMO = ("css selector", "div.grid_grid__2D3md > a[data-type='nav_id751']")
SUB_MENU_SCA_DEMO = ("css selector", "div.grid_grid__2D3md > a[data-type='nav_id1029']")
...
class MenuNewDemo(MenuBase):
    ...
    def from_trading_menu_open_demo(self, d, cur_language, cur_country, link):
        ...
        if cur_country == 'gb':
            ...
            submenu_locator = SUB_MENU_FCA_DEMO
        if cur_country == 'ae':
            menu_locator = MENU_SCA_TRADING
            submenu_locator = SUB_MENU_SCA_DEMO
