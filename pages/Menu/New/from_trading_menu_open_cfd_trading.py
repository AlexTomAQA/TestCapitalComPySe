...
class MenuNew(MenuBase):
    ...
    def from_trading_menu_open_cfd_trading_fca(self, d, cur_language, cur_country, link):
    ...
    @allure.step('Select "Trading" menu, "CFD trading" submenu')
    def from_trading_menu_open_cfd_trading_sca(self, d, cur_language, cur_country, link):
