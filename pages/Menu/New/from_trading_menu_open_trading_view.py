...
trading_view_submenu_loc_fca = ("css selector", "[data-type='nav_id747']")
trading_view_submenu_loc_sca = ("css selector", "[data-type='nav_id820']")
...
class MenuNew(MenuBase):
    ...
    def from_trading_menu_open_trading_view(self, d, cur_language, cur_country, link):
        ...
        if cur_country == 'gb':
            ...
            submenu_locator = trading_view_submenu_loc_fca
        if cur_country == 'ae':
            menu_locator = trading_menu_loc_sca
            submenu_locator = trading_view_submenu_loc_sca
