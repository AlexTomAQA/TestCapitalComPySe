...
trading_submenu_loc_fca = ("css selector", ".helpers_showLg__UPEqH > [data-type='nav_id686']")
trading_submenu_loc_sca = ("css selector", ".helpers_showLg__UPEqH > [data-type='nav_id798']")
...
class MenuNew(MenuBase):
    ...
    def from_trading_menu_open_trading(self, d, cur_language, cur_country, link):
        ...
        if cur_country == 'gb':
            ...
            submenu_locator = trading_submenu_loc_fca
        if cur_country == 'ae':
            menu_locator = trading_menu_loc_sca
            submenu_locator = trading_submenu_loc_sca
