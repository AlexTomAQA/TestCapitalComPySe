...
class AssertClass(BasePage):
    ...
    def assert_page_trading_instrument_on_capital(self, d, cur_language, cur_link, title_instrument):
        print(f"\n{datetime.now()}   3. Assert_v0")
        self.page_capital = Capital(d, cur_link, self.bid)
        self.page_capital.check_open_trading_instrument_page(title_instrument)
