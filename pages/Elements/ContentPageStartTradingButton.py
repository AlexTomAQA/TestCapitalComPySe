...
class ContentStartTrading(BasePage):
    ...
    def element_click(self, cur_item_link, cur_language, cur_role):
        ...
        if self.driver.find_elements(*ButtonsOnPageLocators.BUTTON_START_TRADING_IN_ARTICLE):
    ...
    def arrange_v4(self):
        ...
        item_list = self.driver.find_elements(*ButtonsOnPageLocators.BUTTON_START_TRADING_IN_ARTICLE)
        ...
        for i in range(len(item_list)):
            ...
            if i > 0:
                ...
                # item_list = self.driver.find_elements(
    ...
    def arrange_v2(self):
        ...
        if not item_list:
            print(f"{datetime.now()}   => BUTTON_START_TRADING_IN_ARTICLE2 =>")
            # item_list = self.driver.find_elements(*ButtonsOnPageLocators.BUTTON_START_TRADING_IN_ARTICLE2)
...
#         print(f"{datetime.now()}   Start Click button BUTTON_START_TRADING_IN_ARTICLE =>")
#         if self.driver.find_elements(*ButtonsOnPageLocators.BUTTON_START_TRADING_IN_ARTICLE):
#             self.button_list = self.driver.find_elements(*ButtonsOnPageLocators.BUTTON_START_TRADING_IN_ARTICLE)
#         elif self.driver.find_elements(*ButtonsOnPageLocators.BUTTON_START_TRADING_IN_ARTICLE2):
#             self.button_list = self.driver.find_elements(*ButtonsOnPageLocators.BUTTON_START_TRADING_IN_ARTICLE2)
...
#             #     button_list[i]
#             # )
#             hover = ActionChains(self.driver).move_to_element(self.button_list[i])
#
#             print(f"{datetime.now()}   Is BUTTON_START_TRADING_IN_ARTICLE_#{i + 1} clickable? =>")
