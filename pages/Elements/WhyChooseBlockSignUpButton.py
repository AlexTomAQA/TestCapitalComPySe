...
class WhyChooseBlockSignUpButton(BasePage):
    ...
    def arrange_(self, d, cur_item_link):
        ...
        button_list = self.driver.find_elements(*ContentBlockLocators.WHY_CHOOSE_BLOCK_SIGN_UP_BUTTON)
        ...
        if self.element_is_visible(ContentBlockLocators.WHY_CHOOSE_BLOCK_SIGN_UP_BUTTON):
