...
class ForLearnerTradersBlockTryDemoButton(BasePage):
    ...
    def arrange_(self, d, cur_item_link):
        ...
        button_list = self.driver.find_elements(*ContentBlockLocators.FOR_LEARNER_TRADERS_BLOCK_TRY_DEMO_BUTTON)
        ...
        if self.element_is_visible(ContentBlockLocators.FOR_LEARNER_TRADERS_BLOCK_TRY_DEMO_BUTTON):
