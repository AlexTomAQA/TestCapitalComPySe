...
# from pages.Markets.markets_locators import BlockTradeCFD
# from selenium.common.exceptions import ElementClickInterceptedException
#
#
# class TradeCFDBlockStartTradingNow(BasePage):
#
#     @allure.step(
#         f"{datetime.now()}   Start Full test for Start trading button of Trade CFD Block"
#     )
...
#     #         case "Auth":
#     #             test_element.assert_trading_platform_v4(d, page_url)
#
...
#         if self.element_is_visible(BlockTradeCFD.START_TRADING_NOW_BUTTON):
#             print(f"{datetime.now()}   => BUTTON_START_TRADING is visible on the page!")
#         else:
#             print(
#                 f"{datetime.now()}   => BUTTON_START_TRADING_NOW is not visible on the page!"
#             )
#             pytest.fail(
#                 "Bug! Testing element 'BUTTON_START_TRADING_NOW in Trade CFD Block' is present on this page, "
#                 "but not visible"
#             )
#
#     @allure.step("Click button [Start Trading Now] on Trade CFD Block")
...
#             )
#             pytest.fail(
#                 f"BUTTON_START_TRADING_NOW is not clickable after {time_out} sec."
#             )
#
...
#             print(
#                 f"{datetime.now()}   'Signup' or 'Login' form is automatically opened"
#             )
#
